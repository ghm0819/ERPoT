...
namespace karto
{
  ...
  public:
    ...
    inline Vector2<kt_int32s> WorldToGrid(const Vector2<kt_double>& rWorld, kt_bool flipY = false) const
    {
      ...
      return Vector2<kt_int32s>(static_cast<kt_int32s>(math::Round(gridX - 0.5)), static_cast<kt_int32s>(math::Round(gridY - 0.5)));
    }
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  public:
     ...
     * @param resolution
     */
    OccupancyGrid(kt_int32s width, kt_int32s height, const Vector2<kt_double>& rOffset, kt_double resolution, kt_double occupancy_threshold)
      ...
      , m_pCellUpdater(NULL)
    {
      ...
      m_pOccupancyThreshold = new Parameter<kt_double>("OccupancyThreshold", occupancy_threshold); // 0.05
  ...
  public:
     ...
     * @param resolution
     */
    static OccupancyGrid* CreateFromScans(const LocalizedRangeScanVector& rScans, kt_double resolution, kt_double occupancy_threshold)
    {
      if (rScans.empty())
      {
        return NULL;
      ...
      OccupancyGrid* pOccupancyGrid = new OccupancyGrid(width, height, offset, resolution, occupancy_threshold);
    ...
    OccupancyGrid* Clone() const
    {
      OccupancyGrid* pOccupancyGrid = new OccupancyGrid(GetWidth(),
                                                        ...
                                                        m_pOccupancyThreshold->GetValue());
